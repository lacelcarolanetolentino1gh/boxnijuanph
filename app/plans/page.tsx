  ...
  return (
    <div className="max-w-5xl mx-auto px-6 py-16">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-gray-500 text-lg">Select how many variants you want in your monthly box.</p>
      </div>
          ...
          >
            ...
            <div className="p-6 flex flex-col flex-1 items-center text-center">
              ...
              <p className="text-gray-500 text-sm mb-1">
                {plan.id === "custom" ? "Unlimited variants" : `${plan.items} variants per box`}
              </p>
          ...
          <table className="w-full text-sm text-left">
            ...
            <tbody className="divide-y divide-gray-100">
              {[
                ...
                ["Variants per Box", "3 variants", "5 variants", "8 variants", "Unlimited"],
                ["Full item selection", "✓", "✓", "✓", "✓"],
