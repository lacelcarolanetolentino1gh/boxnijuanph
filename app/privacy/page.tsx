...
export default function PrivacyPage() {
  return (
    <div className="max-w-3xl mx-auto px-6 py-16">
      <div className="mb-10">
        <Link href="/" className="text-sm text-gray-400 hover:text-[#7D9B76] transition-colors">← Back to Home</Link>
      </div>
      ...
      <div className="space-y-10 text-sm text-gray-600 leading-relaxed">
        ...
        <section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {[
              ...
              <div key={item.title} className="bg-[#F5EFE6] rounded-xl p-4">
        ...
        <section>
          ...
          <p className="mt-3 text-xs text-gray-400">
            You may also file a complaint with the <a href="https://www.privacy.gov.ph" target="_blank" rel="noopener noreferrer" className="underline hover:text-[#7D9B76]">National Privacy Commission (NPC)</a> at privacy.gov.ph.
          </p>
        </section>
