...
export default function PrivacyPage() {
  return (
    <div className="max-w-3xl mx-auto px-6 py-16">
      <div className="mb-10">
        <Link href="/" className="text-sm text-gray-400 hover:text-[#84CC16] transition-colors">← Back to Home</Link>
      </div>

      <h1 className="font-[var(--font-dm-sans)] text-4xl font-bold text-[#1C1917] mb-2">Privacy Policy</h1>
      ...
      <div className="space-y-10 text-sm text-gray-600 leading-relaxed">
        ...
        <section>
          <h2 className="font-[var(--font-dm-sans)] font-bold text-lg text-[#1C1917] mb-3">1. Who We Are</h2>
          <p>
        ...
        <section>
          <h2 className="font-[var(--font-dm-sans)] font-bold text-lg text-[#1C1917] mb-3">2. What We Collect</h2>
          ...
          <ul className="space-y-2 list-none">
            {[
              ...
              <li key={field} className="flex gap-3 bg-gray-50 rounded-xl px-4 py-3">
                <span className="font-semibold text-[#1C1917] w-44 shrink-0">{field}</span>
        ...
        <section>
          <h2 className="font-[var(--font-dm-sans)] font-bold text-lg text-[#1C1917] mb-3">3. How We Use Your Data</h2>
        ...
        <section>
          <h2 className="font-[var(--font-dm-sans)] font-bold text-lg text-[#1C1917] mb-3">4. Who We Share It With</h2>
        ...
        <section>
          <h2 className="font-[var(--font-dm-sans)] font-bold text-lg text-[#1C1917] mb-3">5. Data Security</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {[
              ...
              <div key={item.title} className="bg-[#F7FEE7] rounded-xl p-4">
                <p className="text-xl mb-1">{item.icon}</p>
                <p className="font-semibold text-[#1C1917] text-sm mb-0.5">{item.title}</p>
        ...
        <section>
          <h2 className="font-[var(--font-dm-sans)] font-bold text-lg text-[#1C1917] mb-3">6. Your Rights Under RA 10173</h2>
        ...
        <section>
          <h2 className="font-[var(--font-dm-sans)] font-bold text-lg text-[#1C1917] mb-3">7. Data Retention</h2>
          <p>
        ...
        <section>
          <h2 className="font-[var(--font-dm-sans)] font-bold text-lg text-[#1C1917] mb-3">8. Contact Us</h2>
          ...
          <div className="mt-3 bg-gray-50 rounded-xl p-4 text-sm">
            <p className="font-semibold text-[#1C1917]">BoxNiJuanPH — Data Protection Officer</p>
          ...
          <p className="mt-3 text-xs text-gray-400">
            You may also file a complaint with the <a href="https://www.privacy.gov.ph" target="_blank" rel="noopener noreferrer" className="underline hover:text-[#84CC16]">National Privacy Commission (NPC)</a> at privacy.gov.ph.
          </p>
        </section>
