            ...
            <div className="flex flex-col items-center">
              <div
                className={`w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold transition-colors ${
                  isCompleted
                    ? "bg-[#7CAE8E] text-white"
                    : isActive
                    ? "bg-[#7CAE8E] text-white ring-4 ring-[#7CAE8E]/20"
              ...
              <span
                className={`text-xs mt-1 hidden sm:block ${
                  isActive ? "text-[#7CAE8E] font-semibold" : isCompleted ? "text-[#7CAE8E]" : "text-gray-400"
                }`}
              >
                {step.label}
              </span>
            ...
            {i < STEPS.length - 1 && (
              <div
                className={`h-0.5 w-10 sm:w-16 mx-1 mb-4 sm:mb-5 transition-colors ${
                  i < currentIndex ? "bg-[#7CAE8E]" : "bg-gray-200"
                }`}
              />
            )}
          </div>
