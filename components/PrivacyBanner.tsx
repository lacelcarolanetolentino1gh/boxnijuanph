...
export default function PrivacyBanner() {
  ...
  return (
    <div
      ...
      className="bg-[#111827] text-white text-xs px-4 py-2.5 flex items-center justify-between gap-4"
    >
      <p className="text-gray-300 text-center flex-1">
        ...
        <a href="/privacy" className="underline text-[#16A34A] hover:text-green-300 transition-colors">
          Learn more
        </a>
      </p>
      <button
