...
export default function PrivacyBanner() {
  ...
  return (
    <div
      ...
      className="bg-[#1C1917] text-white text-xs px-4 py-2.5 flex items-center justify-between gap-4"
    >
      <p className="text-gray-300 text-center flex-1">
        ...
        <a href="/privacy" className="underline text-[#84CC16] hover:text-green-300 transition-colors">
          Learn more
        </a>
      </p>
      <button
